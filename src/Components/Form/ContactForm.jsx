      ...
      <div className='row row-cols-lg-2 row-cols-1 grid-spacer-2'>
        <div className='col'>
          <div className='contact-details'>
            ...
            <h2
              className='animate-box animate__animated animated'
              data-animate='animate__fadeInUp'>
              Let's Discuss How We Can Support Your Success
            </h2>
            <p>
              Parturient nunc montes, habitasse ligula habitant facilisi. Luctus
              dis penatibus ad augue rutrum. Non gravida sociosqu pellentesque
              cursus dictum. Gravida at luctus sollicitudin sagittis odio
              venenatis adipiscing mus sem.
            </p>
        ...
        <div className='col'>
          ...
          <div className='card form-card'>
            <form
              ...
              id='contactForm'
              className='form d-flex flex-column gspace-2 needs-validation'>
