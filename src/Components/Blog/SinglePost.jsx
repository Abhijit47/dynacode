          ...
          <div className='blog-container'>
            <div className='d-flex flex-column gspace-2'>
              ...
              <div className='row row-cols-md-2 row-cols-1 grid-spacer-2'>
                ...
                <div className='col'>
                  <p>
                    Quam maximus cras augue suspendisse cubilia sed vulputate
                    congue sagittis. Turpis commodo fermentum aliquam facilisis
                    rutrum senectus maximus. Ut donec natoque ac finibus
                    senectus faucibus ante. Facilisi risus auctor ex lacus
                    scelerisque mauris, nostra sed orci.
                  </p>
                  <p>
                    Iaculis est rutrum vulputate nisi erat nullam sed. Consequat
                    orci maecenas purus cursus pellentesque rutrum hac. Proin
                    parturient dignissim elementum magnis aptent fusce curae.
              ...
              <p>
                ...
                fames nam nunc, phasellus ipsum mauris. Aliquam diam netus nec,
                pellentesque ultricies sollicitudin morbi. Dignissim ligula et
                velit integer ultricies tristique. Imperdiet a mattis finibus
                nibh suspendisse auctor rutrum. Fames fermentum iaculis lacinia
                proin diam vitae.
              </p>
              <p>
              ...
              <div className='row row-cols-md-2 row-cols-1 grid-spacer-2'>
                <div className='col'>
                  <ul className='circle-notch-list'>
                    ...
                    <li>
                      Consectetur venenatis penatibus primis tristique ac
                      ultrices
                    </li>
                  </ul>
                </div>
