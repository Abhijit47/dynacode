            ...
            <div className='portfolio-details'>
                ...
                <div className='col'>
                  <div className='d-flex flex-column h-100 gap-4'>
                    ...
                    <ul className='circle-notch-list'>
                      <li>Consequat orci maecenas purus cursus pellentesque</li>
                      ...
                      <li>Quam maximus cras augue suspendisse cubilia</li>
                      <li>Velit himenaeos etiam eu est egestas dis nullam</li>
                    </ul>
                  </div>
                </div>
                <div className='col'>
              ...
              <div>
                <p>
                  ...
                  facilisi. Luctus dis penatibus ad augue rutrum. Non gravida
                  sociosqu pellentesque cursus dictum.
                </p>
                <p>
